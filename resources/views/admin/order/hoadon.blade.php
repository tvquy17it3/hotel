...
<div id="page" class="page">
    <div class="header">
       <!--  <div class="logo"><img src="public\img\logoress.jpg"/></div> -->
        <div class="company">novotel hotel<br/> 
  ...
  <br/>
    ...
    <p class="khachhang">Check In: {{$dataCus->checkIn}}</p>
    <p class="khachhang">Check Out: {{$dataCus->checkOut}}</p>
    <p class="khachhang">Thu ngân: {{$nameA}} </p>
    <p class="khachhang">Mã HĐ: 00{{$orderID}}</p>
    <p class="khachhang">Khách hàng: {{$dataCus->cusName}}</p>
    <p class="khachhang">Điện thoại: {{$dataCus->phone}}</p>
    <br/>
  <table class="TableData">
    ...
    @foreach($dataRoom as $value)
        <tr>
            ...
            <td class="cotTenSanPham">{{$value->name}}</td>
