    ...
    <div class="card-body cutpad">
        <div class="row g-0">
            ...
            <div class="col-3 d-lg-none" style="text-align: center; margin: auto;">
                <p class="card-text" style="margin: 0px;"><small class="text-muted">
                        <button type="button" style="background-color: rgb(242, 169, 0);" class="btn btn-warning">Xem
                            thêm</button>
                    </small></p>
            </div>
        </div>
        ...
        <div class="row g-0">
            ...
            <div class="row g-0">
                <div class="card-body">
                    ...
                    <p class="card-text">Với phòng Deluxe quý khách sẽ được thưởng thức trọn vẹn
                        vẻ
                        đẹp
                        ấn tượng của thành phố ngay trong phòng ngủ của mình. Quý khách sẽ tận
                        hưởng
                        được cảm giác sang trọng, ấm cúng trong lối thiết kế phòng độc đáo với 1
                        giường
                        King và các thiết bị nội thất hiện đại.</p>
                    <div class="row g-0">
                        <div class="col-md-6">
                            <p class="card-text"><small class="text-muted">
